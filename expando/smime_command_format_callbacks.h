...
#ifndef MUTT_EXPANDO_SMIME_COMMAND_FORMAT_CALLBACKS_H
#define MUTT_EXPANDO_SMIME_COMMAND_FORMAT_CALLBACKS_H
...
#endif /* MUTT_EXPANDO_SMIME_COMMAND_FORMAT_CALLBACKS_H */
