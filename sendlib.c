...
int mutt_rfc822_write_header(FILE *fp, struct Envelope *env, struct Body *attach, int mode,
                   ...
                   int post, char *fcc, char **finalpath)
{
   ...
   * */
  mutt_rfc822_write_header(msg->fp, hdr->env, hdr->content, post ? -post : 0, 0, 1);
