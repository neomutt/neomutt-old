...
void test1(struct NeoMutt *n)
{
  ...
  notify_observer_add(n->notify, NT_ALL, neomutt_observer, NULL);
  notify_observer_add(a->notify, NT_ACCOUNT, account_observer, NULL);
  notify_observer_add(m->notify, NT_MAILBOX, mailbox_observer, NULL);
